            ...
            while (i.hasNext()) {
                ...
                var clickHandler = function(event) { 
                    return function(elmt, evt, target) { 
                        ...
                        plot._bubble = SimileAjax.Graphics.createBubbleForPoint(coords.x, parseInt(elmtCoords.top) + parseInt(plot._canvas.height), plot._plotInfo.bubbleWidth, plot._plotInfo.bubbleHeight, "bottom");
