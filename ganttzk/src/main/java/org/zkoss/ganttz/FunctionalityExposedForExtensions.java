...
class FunctionalityExposedForExtensions<T> implements IContext<T> {
    ...
    FunctionalityExposedForExtensions(Planner planner,
     ...
     *            the position in which to register the task at top level.
     ...
     */
    boolean changeType(Dependency dependency, DependencyType type) {
    ...
    public void print() {
        ...
        final Window printProperties = (Window)
                Executions.createComponents("/planner/print_configuration.zul", planner, null);
