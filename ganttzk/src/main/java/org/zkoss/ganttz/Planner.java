...
public class Planner extends HtmlMacroComponent  {
    ...
    public <T> void setConfiguration(PlannerConfiguration<T> configuration) {
        ...
        FunctionalityExposedForExtensions<T> newContext =
                new FunctionalityExposedForExtensions<T>(this, configuration, diagramGraph);
    ...
    GanttZKDiagramGraph getDiagramGraph() {
    ...
    boolean areContainersExpandedByDefault() {
    ...
    private boolean areShownAdvancesByDefault() {
        return shownAdvanceByDefault;
    }

    boolean showAdvancesRightNow() {
    ...
    private boolean areShownReportedHoursByDefault() {
        return shownReportedHoursByDefault;
    }

    boolean showReportedHoursRightNow() {
    ...
    private boolean areShownMoneyCostBarByDefault() {
        return shownMoneyCostBarByDefault;
    }

    boolean showMoneyCostBarRightNow() {
