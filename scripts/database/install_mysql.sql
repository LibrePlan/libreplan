...
--  *********************************************************************
--  Change Log: src/main/resources/db.changelog.xml
--  Ran at: 16/10/12 9:52
--  Against: libreplan@localhost@jdbc:mysql://localhost/libreplanaudiovisualdev
--  Liquibase version: 2.0.5
--  *********************************************************************
...
CREATE TABLE `budget_line_template` (`budget_line_template_id` BIGINT NOT NULL, `cost_or_salary` DECIMAL(19,2) NULL, `duration` INT NULL, `quantity` INT NULL, `indemnization_salary` DECIMAL(19,2) NULL, `holiday_salary` DECIMAL(19,2) NULL, `budget_line_type` INT NULL, CONSTRAINT `budget_line_template_pkey` PRIMARY KEY (`budget_line_template_id`));
...
CREATE TABLE `filming_progress` (`id` BIGINT NOT NULL, `version` BIGINT NOT NULL, `start_date` DATE NULL, `end_date` DATE NULL, `progress_granularity` INT NULL, CONSTRAINT `filming_progress_pkey` PRIMARY KEY (`id`));
...
CREATE TABLE `initial_progress_forecast` (`filming_progress_id` BIGINT NOT NULL, `day` DATE NULL, `scenes` INT NOT NULL);

ALTER TABLE `initial_progress_forecast` ADD PRIMARY KEY (`filming_progress_id`, `day`);
...
CREATE TABLE `progress_forecast` (`filming_progress_id` BIGINT NOT NULL, `day` DATE NULL, `scenes` INT NOT NULL);

ALTER TABLE `progress_forecast` ADD PRIMARY KEY (`filming_progress_id`, `day`);
...
CREATE TABLE `real_progress` (`filming_progress_id` BIGINT NOT NULL, `day` DATE NULL, `scenes` INT NOT NULL);

ALTER TABLE `real_progress` ADD PRIMARY KEY (`filming_progress_id`, `day`);
...
CREATE TABLE `budget` (`budget_id` BIGINT NOT NULL, `order_element_id` BIGINT NULL, CONSTRAINT `budget_pkey` PRIMARY KEY (`budget_id`));
...
ALTER TABLE `budget` DROP FOREIGN KEY `fk_budget_order`;
...
--              MySQL >= 5.5.
ALTER TABLE `order_template` DROP FOREIGN KEY `fk6476ce4ba44abee3`;
...
ALTER TABLE `initial_progress_forecast` MODIFY `scenes` DECIMAL(19,2);

ALTER TABLE `progress_forecast` MODIFY `scenes` DECIMAL(19,2);

ALTER TABLE `real_progress` MODIFY `scenes` DECIMAL(19,2);
...
ALTER TABLE `initial_progress_forecast` CHANGE `scenes` `value` DECIMAL(19,2);

ALTER TABLE `progress_forecast` CHANGE `scenes` `value` DECIMAL(19,2);

ALTER TABLE `real_progress` CHANGE `scenes` `value` DECIMAL(19,2);
...
ALTER TABLE `filming_progress` DROP FOREIGN KEY `fk_filming_progress_per_order`;
...
ALTER TABLE `cashflow_output` ADD PRIMARY KEY (`cashflow_plan_id`, `cashflow_output_position`);
