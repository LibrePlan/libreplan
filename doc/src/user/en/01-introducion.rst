...
* Right-click on the Gantt chart for the project and select *Plan*.
* Access the project list and click on the Gantt diagram icon.
* Create a new project and change the current project view.
...
* **Editing Project View:** This view allows users to modify the details of the project. See the *Projects* section for more information.
...
* **View Management:** The company overview, or multi-project view, is accompanied by various views of the stored information. For example, the company overview allows users to view projects and compare their status, view the company's overall resource load, and manage projects. Users can also access the planning view, resource load view, advanced resource allocation view, and editing project view for individual projects.
...
* **Projects and Project Elements:** Work requested by clients is treated as a project within the application, structured into project elements. The project and its elements follow a hierarchical structure with *x* levels. This element tree forms the basis for work planning.
...
* **Integration with ERP:** The program can directly import information from company ERP systems, including projects, human resources, work reports, and specific criteria.
