...
https://www.libreplan.dev/contact/
...
* Vista de administración de proxectos. Pantalla que amosa o listado de proxectos da empresa onde o usuario poderá realizar as seguintes operacións: filtrar, editar, borrar, visualizar en planificación ou crear novo proxecto. Para acceder a esta vista é necesario premer en *Lista de proxectos*.
...
* Premendo no botón dereito sobre a caixa de diagrama de Gantt do proxecto e seleccionando en *Planificar*.
* Accedendo ó listado de proxectos e premendo na icona simbolizando os diagramas de Gantt.
* Creando un novo proxecto e cambiar de perspectiva sobre o proxecto sendo visualizado.

Sobre un proxecto, a aplicación amosa as seguintes perspectivas:
...
* Vista de edición de proxecto. Vista na que o usuario pode administrar os datos do proxecto. Ver sección de *Proxectos* para máis información..
...
* Xestión de perspectivas: A vista global de empresa ou vista multiproxecto vese complementada coas perspectivas sobre a información que se almacena. Por exemplo, a vista global de empresa permite visualizar os proxectos e contrastar o estado dos mesmos, visualizar a carga xeral de recursos da empresa e administrar os proxectos. Por outro lado, na vista de proxecto, é posible visualizar a planificación, a carga de recursos, a vista de asignación de recursos avanzada e a edición do proxecto relacionado.
...
* Proxecto e elementos de proxecto: Os traballos solicitados polos clientes teñen un reflexo na aplicación en forma de proxecto, que se estrutura en elementos de proxecto. O proxecto cos seus elementos conforman unha estrutura xerárquica en *n* niveis. Esta árbore de elementos é sobre a que se traballe á hora de planificar traballos.
...
* Integración con ERP: A aplicación importará información directamente dos ERP das empresas para os proxectos, recursos humanos, partes de traballo e certos criterios.
