...
nos termos da Licença Pública Geral GNU Affero, conforme publicada pela
Free Software Foundation, seja a versão 3 da Licença, seja
...
Este projeto atualmente aceita doações por meio da organização Open Collective <https://opencollective.com/LibrePlan>.

No âmbito global para o qual o LibrePlan foi projetado em matéria de gestão de planejamento, foi desenvolvido um projeto para resolver alguns problemas comuns de planejamento.

Este projeto foi parcialmente financiado pela Xunta de Galicia, Ministerio de Industria, Turismo e Comercio, e pela União Europeia, Fondo Europeo de Desenvolvemento Rexional.

.. figure:: images/logos.png

:scale: 100

Este projeto fez parte do Plano Avanza:
