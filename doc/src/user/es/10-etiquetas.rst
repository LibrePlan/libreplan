...
i. Cliente: El usuario podría estar interesado en etiquetar las tareas, proyectos o elementos de proyecto en base al cliente que los solicitó.
ii. Zona: El usuario podría estar interesado en etiquetar las tareas, proyectos o elementos de proyecto en base a la zona en la que se realizan.
...
Las etiquetas son entidades que pertenecen a un tipo de etiqueta. Estas entidades pueden ser asignadas a elementos de proyecto. El hecho de asignar una etiqueta a un elemento de proyecto hace que todos los elementos descendientes de dicho elemento hereden la etiqueta a la que pertenecen. El hecho de contar con una etiqueta asignada permite que esos elementos salgan filtrados en los puntos en los que se ofrece la posibilidad de búsqueda:

i. Búsqueda de tareas en el diagrama de Gantt.
ii. Búsqueda de elementos de proyecto en el listado de elementos de proyecto.
iii. Filtrados para informes.

La asignación de etiquetas a elementos de proyecto es cubierta en el capítulo de proyectos.
