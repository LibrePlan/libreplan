...
* Vista de administración de proyectos. Pantalla que muestra el listado de proyectos de la empresa donde el usuario pode realizar las siguientes operaciones: filtrar, editar, borrar, visualizar en planificación o crear nuevo proyecto. Para acceder a esta vista es necesario hacer click en *Lista de proyectos*.
...
* Presionando en el botón derecho sobre la caja de diagrama de Gantt del proyecto y seleccionando en *Planificar*.
* Accediendo al listado de proyectos y haciendo click en el icono simbolizando los diagramas de Gantt.
* Creando un nuevo proyecto y cambiar de perspectiva sobre el proyecto siendo visualizado.

Sobre un proyecto, la aplicación muestra las siguientes perspectivas:
...
* Vista de edición de proyecto. Vista en la que el usuario puede administrar los datos del proyecto. Ver sección de *Proyectos* para más información.
...
* Proyecto y elementos de proyecto: Los trabajos solicitados por los clientes tienen un reflejo en la aplicación en forma de proyecto, que se estructura en elementos de proyecto. El proyecto con sus elementos conforman una estructura jerárquica en *n* niveles. Este árbol de elementos es sobre la que se trabaje a la hora de planificar trabajos.
...
* Integración con ERP: La aplicación importa información directamente de los ERP de las empresas para los proyectos, recursos humanos, partes de trabajo y ciertos criterios.
