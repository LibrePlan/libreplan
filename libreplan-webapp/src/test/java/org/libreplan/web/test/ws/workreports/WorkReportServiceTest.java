...
public class WorkReportServiceTest {
    ...
    private void givenWorkReportTypeStored3() {
        WorkReportType t = givenWorkReportTypeStored(
                false, false, false, HoursManagementEnum.HOURS_CALCULATED_BY_CLOCK, workReportTypeCode3);
    ...
    public void importInvalidLabelsToWorkReport() {
        // Сreate work report with a work report line
        WorkReportDTO workReportDTO = createWorkReportDTO(workReportTypeCode5);

        // Сreate invalid description value to add into head and lines
        ...
        // It assigned a label type LabelTypeA, but it should be a label type LabelTypeB
    ...
    public void importValidWorkReportWithDateAtWorkReportLevel() {
        ...
        */
        ...
        List<WorkReport> workReports = statelessSession
        ...
        WorkReport imported = (WorkReport) statelessSession
                .createCriteria(WorkReport.class)
