...
public interface IOrderElementModel {
    ...
    /**
     * Moves the given <code>{@link OrderElement}</code> to the specified
     * destination <code>{@link Order}</code>
     *
     * @param orderElementTobeMoved
     * @param destinationOrder
     * @param desktop
     */
    void moveOrderElement(OrderElement orderElementTobeMoved,
