...
public class OrderElementTreeController extends TreeController<OrderElement> {
    ...
    public class OrderElementTreeitemRenderer extends Renderer {
        ...
        protected void addCodeCell(final OrderElement orderElement) {
            ...
            Util.bind(textBoxCode, new Util.Getter<String>() {
                ...
                public String get() {
                    ...
                    return orderElement.getCodeWithoutOrderPrefix();
                }
            }, new Util.Setter<String>() {
        ...
        @Override
        protected void addDurationCell(OrderElement element) {
            // TODO Auto-generated method stub
        }

        @Override
        protected void addQuantityCell(OrderElement element) {
            // TODO Auto-generated method stub
        }

        @Override
        protected void addIndemnizationSalaryCell(OrderElement element) {
            // TODO Auto-generated method stub
        }

        @Override
        protected void addHolidaySalaryCell(OrderElement element) {
            // TODO Auto-generated method stub
        }
