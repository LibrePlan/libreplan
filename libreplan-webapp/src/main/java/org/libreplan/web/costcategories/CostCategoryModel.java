...
public class CostCategoryModel extends IntegrationEntityModel implements ICostCategoryModel {
    ...
    public void initCreate() {
        boolean codeAutogenerated = configurationDAO.getConfiguration().getGenerateCodeForCostCategory();
    ...
    @Override
    @Transactional
    public void confirmRemoveCostCategory(CostCategory category) throws InstanceNotFoundException {
    ...
    public Set<IntegrationEntity> getChildren() {
        return (Set<IntegrationEntity>)
                (costCategory != null ? costCategory.getHourCosts() : new HashSet<IntegrationEntity>());
    }
