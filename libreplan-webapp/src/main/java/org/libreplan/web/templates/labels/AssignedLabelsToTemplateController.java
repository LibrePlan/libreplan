 ...
 */
public class AssignedLabelsToTemplateController
        extends AssignedLabelsController<OrderElementTemplate, IOrderTemplatesModel> {
    ...
    public AssignedLabelsToTemplateController() {
        if ( assignedLabelsToTemplateModel == null ) {
