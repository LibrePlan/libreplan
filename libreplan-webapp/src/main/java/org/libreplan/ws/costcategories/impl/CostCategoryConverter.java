...
class CostCategoryConverter {
    ...
    static void updateCostCategory(CostCategory costCategory, CostCategoryDTO costCategoryDTO)
    ...
    private static void updateHourCost(HourCost hourCost, HourCostDTO hourCostDTO) throws ValidationException {
