...
limitingresources.LimitingResourcesPanel = zk.$extends(
...

    {
        ...
        bind_ : function() {
             ...
             * perspective and so all the elements that we are trying to select (
             * as they have the same name), belong to this other perspective .
             * We have to wait until everything is rendered to be sure that we are picking the proper ones.
             *
