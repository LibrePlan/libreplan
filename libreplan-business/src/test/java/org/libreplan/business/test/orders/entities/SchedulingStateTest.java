...
public class SchedulingStateTest {
    ...
    public void whenSchedulingAElementItTurnsAllItsDescendantsIntoScheduledSubelements() {
        root.schedule();
        assertThat(allRootDescendants(), everyItem(hasType(Type.SCHEDULED_SUBELEMENT)));
    }
    ...
    private abstract static class SchedulingStateMatcher extends BaseMatcher<SchedulingState> {
        @Override
